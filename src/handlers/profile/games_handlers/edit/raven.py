...
@router.callback_query(EditProfileForm.raven_cluster)
async def raven_cluster_chosen(
    ...
    await state.set_state(EditProfileForm.raven_server)


@router.callback_query(EditProfileForm.raven_server)
async def raven_server_chosen(
    ...
    await state.set_state(EditProfileForm.raven_class)

@router.callback_query(EditProfileForm.raven_class)
async def raven_class_chosen(
    ...
    await state.set_state(EditProfileForm.raven_level)

@router.message(EditProfileForm.raven_level)
...
@router.message(EditProfileForm.raven_stats)
